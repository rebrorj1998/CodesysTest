...
def print_tree(treeobj, depth, path):
    ...
    if treeobj.is_task:
        exports = [treeobj]
        projects.primary.export_native(exports, os.path.join(curpath, name + '.task.xml'))

    if treeobj.is_libman:
        exports = [treeobj]
        projects.primary.export_native(exports, os.path.join(curpath, name + '.lib.xml'))

    if tp == 'recipe':
        exports = [treeobj]
        projects.primary.export_native(exports, os.path.join(curpath, name + '.recipe.xml'))
